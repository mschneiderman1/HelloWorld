//Version2 of Vocabulary program will help answer if Melville's writing
//has an influence from Shakespeare's work. This version uses regular
//expressions to remove punctuation marks from the end of words.
